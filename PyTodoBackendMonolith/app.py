...
connection_string = "Driver={ODBC Driver 18 for SQL Server};Server=tcp:indian-server.database.windows.net,1433;Database=indian-database;Uid=azureuser;Pwd=Password@12345;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;"
